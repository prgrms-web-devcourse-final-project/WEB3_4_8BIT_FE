...
export default function LoginPage() {
  ...
  const handleSocialLogin = async (provider: 'kakao' | 'naver' ) => {
    ...
    try {
      if (provider === 'kakao') {
        axios.post("https://api.mikki.kr/oauth2/authorization/kakao").then((res) => {
          console.log(res)
          router.push("/")
        })
        router.push("https://api.mikki.kr/oauth2/authorization/kakao")
        // https://api.mikki.kr/oauth2/authorization/kakao
        //   https://api.mikki.kr/oauth2/authorization/naver
        // const response = await fetch("https://api.mikki.kr/oauth2/authorization/kakao")
        // console.log(response)
      } else if (provider === 'naver') {
        // router.push("https://api.mikki.kr/oauth2/authorization/naver")
        const response = await fetch("https://api.mikki.kr/oauth2/authorization/naver")
        console.log(response)
      }
    } finally {
