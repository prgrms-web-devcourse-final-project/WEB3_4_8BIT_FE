...
export default function BoatReservation() {
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="bg-gradient-to-r from-cyan-900 to-blue-900 text-white py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-3xl font-bold mb-4">선상 낚시 예약</h1>
          <p className="text-lg text-cyan-100 max-w-3xl">전국 각지의 선상 낚시 업체 정보와 예약 시스템을 제공합니다.</p>
        </div>
      </div>
          ...
          <div className="lg:col-span-1">
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                <div>
                  <h4 className="font-medium mb-3">편의 시설</h4>
                ...
                <Button variant="outline" className="w-full">
                  <Filter className="h-4 w-4 mr-2" /> 필터 적용
                </Button>
              </CardContent>
            </Card>
          </div>
